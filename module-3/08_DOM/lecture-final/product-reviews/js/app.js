...
{
     const main = document.getElementById('main');  // get reference to the container (main div)

     reviews.forEach( (review) => {
        //create a div and then populate it with other element
        const container = document.createElement('div');
        container.setAttribute('class', 'review');

        //add the reviewer name to our div
       ...
       // attach the container to the end ('beforeend' of the main)
...
function addRating(parent, numberOfStars) {
  ...
  //loop through the number of stars and build an image tag
  for (let n=0; n<numberOfStars; n++) {
    const star = document.createElement('img');
    star.setAttribute('class', 'ratingStar');
    star.src = 'img/star.png';  // OR star.setAttribute('src', 'img/star.png')
