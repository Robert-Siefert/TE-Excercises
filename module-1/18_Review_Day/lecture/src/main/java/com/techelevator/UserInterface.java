...
public class UserInterface {
    ...
    public void printHomes(List<Home> homesToPrint) {
        ...
        for (Home home : homesToPrint) {
            ...
            System.out.println("Number of Bedrooms: " + home.getNumberOfBedrooms());
            System.out.println("Square Feet: " + home.getSquareFeet());

            if (home.getAddress() != null) {
                System.out.println("\nAddress");
                System.out.println(home.getAddress().getAddressLine1());
                System.out.println(home.getAddress().getCity() + " " + home.getAddress().getState() + " " + home.getAddress().getZip());
            }
