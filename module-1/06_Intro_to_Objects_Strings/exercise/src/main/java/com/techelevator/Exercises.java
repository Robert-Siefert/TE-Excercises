...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		return new String(out.substring(0,2)+word+out.substring(2,4));
	}
	...
	public String extraEnd(String str) {
		return new String(str.substring(str.length()-2,str.length())+str.substring(str.length()-2,str.length())+str.substring(str.length()-2,str.length()));
	}
	...
	public String comboString(String a, String b) {
		...
		return new String(shorter + longer + shorter);
	}
	...
	public String nonStart(String a, String b) {
		return new String(a.substring(1,a.length()) + b.substring(1,b.length()));
	}
	...
	public String left2(String str) {
		return new String(str.substring(2,str.length())+str.substring(0,2));
	}
	...
	public String right2(String str) {
		return new String(str.substring(str.length()-2,str.length()) + str.substring(0,str.length()-2));
	}
	...
	public String middleTwo(String str) {
		...
		return new String(str.substring(str.length()/2-1,str.length()/2+1));
	}
	...
	public String nTwice(String str, int n) {
		return new String(str.substring(0,n)+str.substring(str.length()-n,str.length()));
	}
	...
	public String middleThree(String str) {
		return new String(str.substring(str.length()/2-1,str.length()/2+2));
	}
	...
	public String stringTimes(String str, int n) {
		...
		String stringTimes = new String(str);
		for (int i=1; i<n;i++) {
	...
	public String altPairs(String str) {
		String altPairs = new String();
		for(int i=0;i<str.length();i+=4){
			altPairs = altPairs + str.charAt(i);
			if(i+1<str.length()){
				altPairs = altPairs + str.charAt(i+1);
			}
