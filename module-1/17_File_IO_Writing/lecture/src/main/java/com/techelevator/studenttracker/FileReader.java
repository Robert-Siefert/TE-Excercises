...
public class FileReader {
    ...
    public List<Student> readStudentFile(String fileName) throws FileNotFoundException, BobException {
...
//        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                //dumb code just to illustrate a custom exception
                if (fields[0].equalsIgnoreCase("bob")) {
                    throw new BobException();   //creates the exception
                }
